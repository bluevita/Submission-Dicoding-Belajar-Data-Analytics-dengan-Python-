...
1. File Structures
<img width="155" alt="image" src="https://github.com/bluevita/Submission-Dicoding-Belajar-Data-Analytics-dengan-Python-/assets/99781596/7f0ac70a-a7d2-4897-b913-e270ecfccb1f">
...
Note: Numbers 1 to 3 are in the dicoding-collection-exercise and number 4 is in the dashboard.

4. Getting Started
notebook.ipynb
Download this project.
Open your favourite IDE like Jupyter Notebook or Google Colaboratory (but here I will use Google Colab).
...
Download this project.
Install the Streamlit in your terminal or command prompt using pip install streamlit. Install another library like pandas, numpy, scipy, matplotlib, and Seaborn if you haven't already.
Please note, don't move the CSV file because it acts as a data source. keep it in one folder as dashboard.py
